...
Nosso modelo mais inteligente, o melhor do mundo em compreensão multimodal, tudo com base em raciocínio de última geração.
...
Modelo de trabalho de alto volume e sensível a custos com o desempenho e a qualidade da série Gemini 3.
...
Um modelo de visão-linguagem (VLM, na sigla em inglês) que traz os recursos de agentes do Gemini para a robótica e permite raciocínio avançado no mundo físico.
...
Insira milhões de tokens nos modelos do Gemini e extraia a compreensão de imagens, vídeos e documentos não estruturados.
...
Crie conteúdo de vídeo de alta qualidade com comandos de texto ou imagem usando nosso modelo de última geração.
