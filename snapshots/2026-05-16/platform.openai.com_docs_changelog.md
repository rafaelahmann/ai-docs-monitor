...
Released Realtime 2, a new realtime voice model with configurable reasoning for speech-to-speech agents, along with Realtime Translate for streaming speech translation and Realtime Whisper for streaming speech-to-text.
...
Released gpt-realtime-1.5 to the Realtime API. Read more here.
...
Released GPT-5 family of models in the API, including 
gpt-5
, 
gpt-5-mini
, and 
